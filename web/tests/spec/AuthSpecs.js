import { Auth, auth, utility } from '../../build/bundle.js';

let A = new Auth("http://localhost:9001", null);
...
describe("RMCS Auth test", function() {
    ...
    it("should create procedures on API 1", function(done) {
        auth.create_procedure(A, { id: proc_id_1, api_id: api_id_1, name: "ReadResourceData" }, (e, r) => {
            expect(e).toBeNull(e);
            auth.create_procedure(A, { id: proc_id_2, api_id: api_id_1, name: "CreateData" }, (e, r) => {
                expect(e).toBeNull(e);
                auth.create_procedure(A, { id: proc_id_3, api_id: api_id_1, name: "DeleteData" }, (e, r) => {
                    expect(e).toBeNull(e);
                    done();
                });
            });
    ...
    it("should create procedures on API 2", function(done) {
        auth.create_procedure(A, { id: proc_id_4, api_id: api_id_2, name: "ReadConfig" }, (e, r) => {
            expect(e).toBeNull(e);
            done();
        });
    });
    ...
    it("should read multiple API", function(done) {
        auth.list_api_by_category(A, { category: "RESOURCE" }, (e, r) => {
            expect(e).toBeNull(e);
            const api_ids = [];
            let api;
    ...
    it("should read procedures", function(done) {
        auth.list_procedure_by_api(A, { id: api_id_1 }, (e, r) => {
            expect(e).toBeNull(e);
            const proc_ids = [];
    ...
    it("should create administrator role and access for API 1", function(done) {
        auth.create_role(A, {
            ...
            expect(e).toBeNull(e);
            auth.add_role_access(A, { id: role_admin_id, procedure_id: proc_id_1 }, (e, r) => {
                expect(e).toBeNull(e);
                auth.add_role_access(A, { id: role_admin_id, procedure_id: proc_id_2 }, (e, r) => {
                    expect(e).toBeNull(e);
                    auth.add_role_access(A, { id: role_admin_id, procedure_id: proc_id_3 }, (e, r) => {
                        expect(e).toBeNull(e);
                        done();
                    });
                });
    ...
    it("should create user role and access for API 1", function(done) {
        auth.create_role(A, {
            ...
            expect(e).toBeNull(e);
            auth.add_role_access(A, { id: role_user_1_id, procedure_id: proc_id_1 }, (e, r) => {
                expect(e).toBeNull(e);
                done();
            });
        });
    ...
    it("should create user role and access for API 2", function(done) {
        auth.create_role(A, {
            ...
            expect(e).toBeNull(e);
            auth.add_role_access(A, { id: role_user_2_id, procedure_id: proc_id_4 }, (e, r) => {
                expect(e).toBeNull(e);
                done();
            });
        });
    ...
    it("should read roles on API 1", function(done) {
        auth.list_role_by_api(A, { id: api_id_1 }, (e, r) => {
            expect(e).toBeNull(e);
            const role_ids = [];
            let role;
    ...
    it("should update API 1", function(done) {
        auth.update_api(A, { id: api_id_1, name: api_name, description: "New resource api" }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_api(A, { id: api_id_1 }, (e, r) => {
                expect(e).toBeNull(e);
    ...
    it("should update API 1", function(done) {
        auth.update_api(A, { id: api_id_1, name: api_name, description: "New resource api" }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_api_by_name(A, { name: api_name }, (e, r) => {
                expect(e).toBeNull(e);
    ...
    it("should update a procedure", function(done) {
        auth.update_procedure(A, { id: proc_id_1, name: proc_name, description: "Read resource data" }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_procedure_by_name(A, { api_id: api_id_1, name: proc_name }, (e, r) => {
                expect(e).toBeNull(e);
    ...
    it("should update administrator role", function(done) {
        auth.update_role(A, { id: role_admin_id, name: role_name, ip_lock: true }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_role_by_name(A, { api_id: api_id_1, name: role_name }, (e, r) => {
                expect(e).toBeNull(e);
    ...
    it("should create administrator user and add associated roles", function(done) {
        auth.create_user(A, {
            ...
            expect(e).toBeNull(e);
            auth.add_user_role(A, { user_id: admin_id, role_id: role_admin_id }, (e, r) => {
                expect(e).toBeNull(e);
                auth.add_user_role(A, { user_id: admin_id, role_id: role_user_2_id }, (e, r) => {
                    expect(e).toBeNull(e);
                    done();
                });
            });
    ...
    it("should create regular user and add associated roles", function(done) {
        auth.create_user(A, {
            ...
            expect(e).toBeNull(e);
            auth.add_user_role(A, { user_id: user_id, role_id: role_user_1_id }, (e, r) => {
                expect(e).toBeNull(e);
                auth.add_user_role(A, { user_id: user_id, role_id: role_user_2_id }, (e, r) => {
                    expect(e).toBeNull(e);
                    done();
                });
            });
    ...
    it("should read users of user 2 role", function(done) {
        auth.list_user_by_role(A, { id: role_user_2_id }, (e, r) => {
            expect(e).toBeNull(e);
            const user_ids = [];
            let user;
    ...
    it("should update administrator user", function(done) {
        auth.update_user(A, { id: admin_id, password: "N3w_P4s5w0rd" }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_user_by_name(A, { name: "administrator" }, (e, r) => {
                expect(e).toBeNull(e);
    ...
    it("should create access tokens", function(done) {
        auth.create_access_token(A, { user_id: admin_id, auth_token: auth_token, expire: expire_1, ip: ip }, (e, r) => {
            expect(e).toBeNull(e);
            access_id_1 = r.access_id;
            expect(r.auth_token).toEqual(auth_token);
            auth.create_access_token(A, { user_id: admin_id, auth_token: auth_token, expire: expire_1, ip: "" }, (e, r) => {
                expect(e).toBeNull(e);
    ...
    it("should create an auth token", function(done) {
        auth.create_auth_token(A, { user_id: admin_id, expire: expire_2, ip: ip, number: 1 }, (e, r) => {
            expect(e).toBeNull(e);
    ...
    it("should read an access token", function(done) {
        auth.read_access_token(A, { access_id: access_id_2 }, (e, r) => {
            expect(e).toBeNull(e);
    ...
    it("should read auth tokens", function(done) {
        auth.list_auth_token(A, { auth_token: auth_token }, (e, r) => {
            expect(e).toBeNull(e);
            let token;
    ...
    it("should read tokens associated with user", function(done) {
        auth.list_token_by_user(A, { id: admin_id }, (e, r) => {
            expect(e).toBeNull(e);
    ...
    it("should update an access token", function(done) {
        auth.update_access_token(A, { access_id: access_id_2, expire: expire_3 }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_access_token(A, { access_id: access_id_2 }, (e, r) => {
                expect(e).toBeNull(e);
    ...
    it("should update auth tokens", function(done) {
        auth.update_auth_token(A, { auth_token: auth_token, expire: expire_3, ip: [192, 168, 0, 100] }, (e, r) => {
            expect(e).toBeNull(e);
            auth.list_auth_token(A, { auth_token: auth_token }, (e, r) => {
    ...
    it("should login a user", function(done) {
        auth.user_login(A, {
            ...
            expect(api_ids).toContain(api_id_2);
            auth.list_token_by_user(A, { id: user_id }, (e, r) => {
    ...
    it("should failed to delete a role", function(done) {
        auth.delete_role(A, { id: role_user_2_id }, (e, r) => {
    ...
    it("should failed to delete an API", function(done) {
        auth.delete_api(A, { id: api_id_2 }, (e, r) => {
            expect(e).not.toBeNull(e);
            done();
        });
    });
    ...
    it("should failed to delete a user", function(done) {
        auth.delete_user(A, { id: user_id }, (e, r) => {
            expect(e).not.toBeNull(e);
            done();
        });
    });
    ...
    it("should delete tokens", function(done) {
        auth.delete_token_by_user(A, { id: admin_id }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_access_token(A, { access_id: access_id_1 }, (e, r) => {
                expect(e).not.toBeNull(e);
                done();
            });
        });
    ...
    it("should delete regular user", function(done) {
        auth.remove_user_role(A, { user_id: user_id, role_id: role_user_1_id }, (e, r) => {
            expect(e).toBeNull(e);
            auth.remove_user_role(A, { user_id: user_id, role_id: role_user_2_id }, (e, r) => {
                expect(e).toBeNull(e);
                auth.delete_user(A, { id: user_id }, (e, r) => {
                    expect(e).toBeNull(e);
                    auth.read_user(A, { id: user_id }, (e, r) => {
                        expect(e).not.toBeNull(e);
                        done();
                    });
                });
    ...
    it("should delete user role", function(done) {
        auth.remove_user_role(A, { user_id: admin_id, role_id: role_user_2_id }, (e, r) => {
            expect(e).toBeNull(e);
            auth.remove_role_access(A, { id: role_user_2_id, procedure_id: proc_id_4 }, (e, r) => {
                expect(e).toBeNull(e);
                auth.delete_role(A, { id: role_user_2_id }, (e, r) => {
                    expect(e).toBeNull(e);
                    auth.read_role(A, { id: role_user_2_id }, (e, r) => {
                        expect(e).not.toBeNull(e);
                        done();
                    });
                });
    ...
    it("should delete a procedure", function(done) {
        auth.delete_procedure(A, { id: proc_id_4 }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_procedure(A, { id: proc_id_4 }, (e, r) => {
                expect(e).not.toBeNull(e);
                done();
            });
        });
    ...
    it("should delete API 2", function(done) {
        auth.delete_api(A, { id: api_id_2 }, (e, r) => {
            expect(e).toBeNull(e);
            auth.read_api(A, { id: api_id_2 }, (e, r) => {
                expect(e).not.toBeNull(e);
                done();
            });
        });
