...
def read_type(resource, id: UUID):
    with grpc.insecure_channel(resource.address) as channel:
        ...
        response = stub.ReadType(request)
...
def list_type_by_name(resource, name: str):
    with grpc.insecure_channel(resource.address) as channel:
        ...
        response = stub.ListTypeByName(request)
        ls = []
...
def create_type(resource, name: str, description: str):
    with grpc.insecure_channel(resource.address) as channel:
        ...
        response = stub.CreateType(request)
