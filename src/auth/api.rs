...
pub(crate) async fn read_api(channel: &Channel, id: u32)
    -> Result<ApiSchema, Status>
{
    let mut client = ApiServiceClient::new(channel.to_owned());
...
pub(crate) async fn update_api(channel: &Channel, id: u32, name: Option<&str>, address: Option<&str>, category: Option<&str>, description: Option<&str>, password: Option<&str>, keys: Option<()>)
    -> Result<(), Status>
{
    let mut client = ApiServiceClient::new(channel.to_owned());
...
pub(crate) async fn delete_api(channel: &Channel, id: u32)
    -> Result<(), Status>
{
    let mut client = ApiServiceClient::new(channel.to_owned());
    let request = Request::new(ApiId {
...
pub(crate) async fn read_procedure(channel: &Channel, id: u32)
...
pub(crate) async fn update_procedure(channel: &Channel, id: u32, name: Option<&str>, description: Option<&str>)
    -> Result<(), Status>
{
    let mut client = ApiServiceClient::new(channel.to_owned());
...
pub(crate) async fn delete_procedure(channel: &Channel, id: u32)
    -> Result<(), Status>
{
    let mut client = ApiServiceClient::new(channel.to_owned());
    let request = Request::new(ProcedureId {
